...
$sql = "SELECT * FROM survey_templates WHERE Template_category=9 ORDER BY Template_name ASC";
...
<head>
  <meta charset="utf-8">
  <title>Trainings templates - SurveyEase</title>
