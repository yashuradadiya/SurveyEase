...
$sql = "SELECT * FROM survey_templates WHERE Template_category=8 ORDER BY Template_name ASC";
...
<head>
  <meta charset="utf-8">
  <title>Not-for-profits templates - SurveyEase</title>
    ...
    <div class="template-list">
      ...
      <div class="templates_col02">
        <div class="templates-header-row">
          <h3>Not-for-profit templates</h3>
        </div>
