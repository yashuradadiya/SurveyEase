...
$sql = "SELECT * FROM survey_templates ORDER BY Template_name ASC";
          ...
          <div class="w-dyn-list">
            <div role="list" class="w-dyn-items">
              ...
              <div role="listitem" class="category-item w-dyn-item">
                <a href="./<?php echo $row_category['Category']; ?>.php" class="category-link"><?php echo $row_category['Category']; ?></a>
              </div>
              <?php } ?>
            </div>
          </div>
