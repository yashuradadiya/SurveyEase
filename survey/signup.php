...
if (isset($_POST['submit'])) {
  ...
  $sql_select = "SELECT * FROM survey_creator WHERE Email='$email';";
  ...
  if ($cnt <= 0) {
    ...
    if ($responce == 'true') {
      ...
      $_SESSION['survey_name'] = $name;
      $_SESSION['survey_email'] = $email;
      $_SESSION['survey_contact'] = $contact;
      $_SESSION['survey_password'] = $password;
      $_SESSION['survey_sub'] = $sub;
